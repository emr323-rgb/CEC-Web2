...
interface StaffImageUploadWithCropProps {
  currentImageUrl: string | null;
  onImageUploaded: (imageUrl: string) => void;
}

export default function StaffImageUploadWithCrop({ 
  currentImageUrl, 
  onImageUploaded 
}: StaffImageUploadWithCropProps) {
    ...
    try {
      ...
      if (data.success && data.file.path) {
        ...
        toast({
          ...
          description: "The staff photo has been uploaded and cropped.",
        });
      } else {
    ...
    <div className="space-y-4">
      ...
      {showCropper && imageSrc && (
        <div className="rounded-lg border overflow-hidden p-4 space-y-4">
          <h3 className="font-medium text-sm">Position and crop the photo</h3>
          <p className="text-xs text-muted-foreground">Adjust to ensure the face is centered in the frame</p>
